...
RUN apk add git zsh mc curl openssh gcc musl-dev zlib-dev jpeg-dev freetype-dev openjpeg-dev tiff-dev vim mariadb-dev tzdata libxslt-dev \
&& git clone -b del_fb2_without_zip https://github.com/mbrbug/mbr-docker-sopds.git sopds
WORKDIR /sopds
